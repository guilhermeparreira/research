...
Exercícios para fixação, recomendo que usem o $\texttt{R}$ e/ou $\texttt{python}$ para auxiliar e verificar suas respostas.
...
duas matrizes. Não esqueça de verificar se as matrizes são compatíveis.
...
c) Resolva o sistema usando o método de Gauss-Jordan.
...
em $\texttt{R}$ de pelo menos três formas diferentes e compare o tempo
